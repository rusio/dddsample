...
public class CargoRepositoryInMem implements CargoRepository {
  ...
  public void init() throws Exception {
    ...
    final Cargo cargoXYZ = createCargoWithDeliveryHistory(xyz,
                                                          STOCKHOLM,
                                                          MELBOURNE,
    ...
    final Cargo cargoZYX = createCargoWithDeliveryHistory(zyx,
                                                          MELBOURNE,
                                                          STOCKHOLM,
    ...
    final Cargo cargoABC = createCargoWithDeliveryHistory(abc,
                                                          STOCKHOLM,
                                                          HELSINKI,
    ...
    final Cargo cargoCBA = createCargoWithDeliveryHistory(cba,
                                                          HELSINKI,
                                                          STOCKHOLM,
