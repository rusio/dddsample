...
public class ObjectFactory {
  ...
  private final static QName _SubmitReport_QNAME = new QName("http://ws.handling.interfaces.dddsample.citerus.se/",
                                                             "submitReport");
  private final static QName _HandlingReportErrors_QNAME = new QName("http://ws.handling.interfaces.dddsample.citerus.se/",
                                                                     "HandlingReportErrors");
  private final static QName _SubmitReportResponse_QNAME = new QName("http://ws.handling.interfaces.dddsample.citerus.se/",
  ...
  public JAXBElement<HandlingReportErrors> createHandlingReportErrors(HandlingReportErrors value) {
    return new JAXBElement<HandlingReportErrors>(_HandlingReportErrors_QNAME,
  ...
  public JAXBElement<SubmitReportResponse> createSubmitReportResponse(SubmitReportResponse value) {
    return new JAXBElement<SubmitReportResponse>(_SubmitReportResponse_QNAME,
